...
const sidebarItems = [
  ...
  { icon: Flag, label: 'Reports', href: '/admin/reports', active: true },
        ...
        <main className="p-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review reported listings and users</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12 text-muted-foreground">
                <Flag className="w-16 h-16 mx-auto mb-4 opacity-50" />
                <h3 className="text-lg font-medium mb-2">No Reports</h3>
                <p>User reports about scams, fake listings, or policy violations will appear here.</p>
              </div>
            </CardContent>
          </Card>
        </main>
