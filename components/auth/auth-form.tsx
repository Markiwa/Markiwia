    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground">
          {mode === 'login' ? 'Redirecting to dashboard...' : 'Your account has been created successfully.'}
        </p>
      </motion.div>
    );
  }
      ...
      <AnimatePresence>
        {error && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="bg-destructive/10 border border-destructive/20 text-destructive rounded-lg p-3 mb-4 flex items-center gap-2"
          >
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center">
                ...
                {s < 3 && (
                  <div className={`w-8 h-1 ${s < step ? 'bg-primary' : 'bg-muted'}`} />
                )}
              </div>
            ))}
          </div>
